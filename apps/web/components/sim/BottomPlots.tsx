...
const buildSeries = (samples: readonly Record<string, number>[], key: string) =>
  samples
...
export const BottomPlots = () => {
  ...
  const trimmed = useMemo(() => samples.slice(-600), [samples]);
  ...
  return (
    <div
      className={order-t border-slate-200 bg-white/90 backdrop-blur transition-[max-height] duration-200 dark:border-slate-800 dark:bg-slate-950/90 }
    >
